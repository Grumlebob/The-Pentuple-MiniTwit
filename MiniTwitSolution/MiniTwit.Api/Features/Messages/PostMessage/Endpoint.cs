...
public static class Endpoint
{
    ...
    {
        routes.MapPost("/message", async (PostMessageRequest request, MiniTwitDbContext db) =>
        {
            ...
            var responseDto = new PostMessageResponse(message.MessageId, message.AuthorId, message.Text, message.PubDate);
